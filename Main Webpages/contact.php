...
<head> 
	<meta charset ="utf-8"> 
	<title>Contact Us - ideablr</title> 
...
<form method="post" action="contactengine.php">
  <div class="container">
  	<fieldset>    
		<legend><strong><div class="formtitle">Problem? Critique? Recommendation? <font size="24px"><br/>Contanct Us!</font></div><br/></strong></legend><br/>
		<label><font color="#181933"><b>Name</b></font><font color="red"> *</font></label><br/>
		<input type="text" placeholder="Name" name="Name" id="Name"required><br/><br/><br/>
		
		<label><font color="#181933"><b>Email</b></font><font color="red"> *</font></label><br/>
		<input type="text" placeholder="Email" name="Email" id="Email"required><br/><br/><br/>
		
		<label><font color="#181933"><b>Message</b></font><font color="red"> *</font></label><br/>
			<textarea rows="10" class="styled"  name="Message" id="Message" required>Your message goes here.</textarea><br/><br/><br/>
